...
def getDraw(colorframe):
    def getdrawmask():
        ...
        # https://stackoverflow.com/questions/56953097/opencv-inrange-is-working-for-rgb-but-not-hsv-color-space # TODO: try this
    ...
    result = getdrawmask()
    return cv2.bitwise_and(colorframe, colorframe, mask = result)
